...
hook.Add("HUDPaint" , "DrawMyHud", function()
	...
	--KeyWords
  local Keyword_1 = SelfEnhancements.TextEntries["Word1"]
  local Keyword_2 = SelfEnhancements.TextEntries["Word2"]
  local Keyword_3 = SelfEnhancements.TextEntries["Word3"]              
	local Keyword_4 = SelfEnhancements.TextEntries["Word4"]
  local Keyword_5 = SelfEnhancements.TextEntries["Word5"]
  local Keyword_6 = SelfEnhancements.TextEntries["Word6"]                  
  local Keyword_7 = SelfEnhancements.TextEntries["Word7"]
  local Keyword_8 = SelfEnhancements.TextEntries["Word8"]  
  local Keyword_9 = SelfEnhancements.TextEntries["Word9"] 
  local Keyword_10 = SelfEnhancements.TextEntries["Word10"]                  
                    
	if( text == Keyword_1) then
	...
	if input.IsKeyDown(KEY_)then
		stop()
		end

	end)
	end)
  //done with the keyword checker!
	...
	AddCheckBox( KeyFind, "Closer", 15, 65, "Turns the alert box off after X amout of time.", "Alert_Time" )
  ...
  AddCheckBox( KeyFind, "Keyword 10", 15, 345, "Adds Keyword #10", "keyword_10" )         
	AddTextEntry( KeyFind, 485, 100, 162, "", "Word1", true )
	AddTextEntry( KeyFind, 485, 100, 182, "", "Word2", true )
	AddTextEntry( KeyFind, 485, 100, 202, "", "Word3", true )
	AddTextEntry( KeyFind, 485, 100, 222, "", "Word4", true )
	AddTextEntry( KeyFind, 485, 100, 242, "", "Word5", true )
  AddTextEntry( KeyFind, 485, 100, 262, "", "Word6", true )
  AddTextEntry( KeyFind, 485, 100, 282, "", "Word7", true ) 
  AddTextEntry( KeyFind, 485, 100, 302, "", "Word8", true )
  AddTextEntry( KeyFind, 485, 100, 322, "", "Word9", true )
  AddTextEntry( KeyFind, 485, 100, 342, "", "Word10", true )          
	//Config Tab
