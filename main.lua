...
function SelfEnhancementsMenu()
	...
	AddCheckBox( keyfind, "Message 1", 15, 265, "Enable spam message #1", "Spam_Message_1" )
	AddCheckBox( keyfind, "Message 2", 15, 285, "Enable spam message #2", "Spam_Message_2" )
	AddCheckBox( keyfind, "Message 3", 15, 305, "Enable spam message #3", "Spam_Message_3" )
	AddCheckBox( keyfind, "Message 4", 15, 325, "Enable spam message #4", "Spam_Message_4" )
	AddCheckBox( keyfind, "Message 5", 15, 345, "Enable spam message #5", "Spam_Message_5" )
	AddTextEntry( keyfind, 485, 100, 262, "", "Spam1", true )
	AddTextEntry( keyfind, 485, 100, 282, "", "Spam2", true )
	AddTextEntry( keyfind, 485, 100, 302, "", "Spam3", true )
	AddTextEntry( keyfind, 485, 100, 322, "", "Spam4", true )
	AddTextEntry( keyfind, 485, 100, 342, "", "Spam5", true )
	//Config Tab
